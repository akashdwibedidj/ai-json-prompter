...
# # Set your API key safely as an environment variable
# os.environ["MISTRAL_API_KEY"] = os.getenv("MISTRAL_API_KEY")

# # Initialize the client (it automatically looks for MISTRAL_API_KEY)
# client = Mistral()

# client = OpenAI(
#     api_key=os.getenv("MISTRAL_API_KEY"),
#     base_url="https://mistral.ai/v1"  # Connects OpenAI client to Mistral servers
# )
...
def call_llm_with_structure(prompt: str, schema_model: BaseModel, error_feedback: str = None):
    ...
    try:
        ...
        if hasattr(response, 'usage') and response.usage:
            ...
            print("📊 [Token Usage] Metadata not returned by local provider.")
...
if __name__ == "__main__":
    user_idea = "Build a CRM with login, contacts, dashboard, role-based access, and premium plan with payments. Admins can see analytics"
